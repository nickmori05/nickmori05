...
| --- | --- | --- |
| [Ticket Backend](https://github.com/nickmori05/ticket-backend) | Track support tickets through HTTP or the terminal | Request validation, transactional history, shared Docker storage |
...
Currently learning: API access control, database migrations, and reliable
background jobs. The goal is to understand how a backend behaves when data,
